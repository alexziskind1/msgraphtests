...
var getAllFor = function (key, entityName) {
    var entityData;
...
var inheritanceChainFor = function (entityName) {
...
var completeEntityData = function (name) {
...
_(entityTypesData).keys().forEach(function (entityName) {
    return exports.e[entityName] = new EntityType(completeEntityData(entityName));
});
//# sourceMappingURL=Entity_types.js.map